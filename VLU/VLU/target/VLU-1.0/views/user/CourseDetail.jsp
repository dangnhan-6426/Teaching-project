...
<html>
    <head>
        ...
        <title>Chi Tiết Khóa Đào Tạo </title>
    ...
    <body>
        ...
        <jsp:include page="../../layouts/user/NavBar.jsp"></jsp:include>
            ...
            <section class="heading" data-aos="fade-left" data-aos-duration="40000">
                <h3>Chi Tiết Khóa Đào Tạo</h3>
                <p> <a href="${pageContext.request.contextPath}/home">Trang Chủ >></a> <a href="${pageContext.request.contextPath}/course">Khóa Đào Tạo >></a> Chi Tiết Khóa Đào Tạo </p>
        </section>
