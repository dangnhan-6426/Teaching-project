...
<html>
    ...
    <body ng-app="user-app">
        ...
        <section class="heading" data-aos="slide-left" data-aos-duration="40000">
            <h3>Khóa Đào Tạo Trong Trường</h3>
        </section>
        ...
        <section class="blog" data-aos="slide-left" data-aos-duration="40000" ng-controller="abc">
            <div class="box" ng-repeat="inside in insides">
                <div class="images">
                    <img src="data:image/png;base64,{{inside.imageCourse}}" alt="" />
                </div>
                <div class="content">
                    <div class="icons">
                        <a href="#"> Bắt đầu: {{inside.startDate}} <br> Kết Thúc: {{inside.endDate}}</a>
                    </div>
                    <h3>{{inside.courseName}}</h3>
                </div>
            </div>
        </section>
