                                ...
                                <table class="table table-striped table-bordered templatemo-user-table">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="course in listCourses | filter: searching">
                                            ...
                                            <td style="display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100px; height: 100%; border-bottom: none; border-left: none; border-right: none;">
